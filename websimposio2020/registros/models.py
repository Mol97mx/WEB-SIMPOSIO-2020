...
class registro(models.Model):
    ...
    cfdi=models.CharField(max_length=50,blank=True)
    formadepago=models.CharField(max_length=50,blank=True)
    metododepago=models.CharField(max_length=50,blank=True)
